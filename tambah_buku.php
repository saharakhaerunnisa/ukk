...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO buku (IDBuku, kategori, namaBuku, harga, stock, penerbitID)
              VALUES ('$IDBuku', '$kategori', '$namaBuku', '$harga', '$stock', '$penerbitID')";

    if (mysqli_query($koneksi, $query)) {
        echo "<script>alert('Data buku berhasil ditambahkan'); window.location='admin.php';</script>";
    } else {
    ...
    <div class="container">
        ...
        <form method="POST">
            <div class="form-group">
                ...
                <input type="text" id="IDBuku" name="IDBuku" placeholder="Masukkan ID Buku" required>
            ...
            <div class="form-group">
                ...
                <input type="text" id="namaBuku" name="namaBuku" placeholder="Masukkan Nama Buku" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" id="stock" name="stock" placeholder="Masukkan Jumlah Stock" min="0" required>
            </div>
